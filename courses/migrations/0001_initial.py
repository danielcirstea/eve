# Generated by Django 2.0.1 on 2018-01-22 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.IntegerField(choices=[(0, '1'), (1, '2')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lecture_category', models.IntegerField(choices=[(0, 'Classes '), (1, 'Seminars')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('studies_type', models.IntegerField(choices=[(0, 'Bachelor Studies'), (1, 'Master Studies'), (2, 'PhD Studies'), (3, 'Integrated Studies')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_ID', models.CharField(max_length=14, unique=True, validators=[django.core.validators.RegexValidator(message='The ID needs to be 14 characters long.', regex='^.{14}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('photo', models.ImageField(upload_to='teachers_images')),
                ('email', models.EmailField(max_length=254)),
                ('phone', models.CharField(max_length=15)),
                ('website', models.URLField(blank=True, help_text='E.g.: https://www.example.com')),
            ],
        ),
        migrations.AddField(
